> This page location: TikTok for Developers > scopes-overview
> Full documentation base: https://developers.tiktok.com/docs/en/
> Source: https://developers.tiktok.com/docs/en/scopes-overview
> Rendered from: https://r.jina.ai/https://developers.tiktok.com/docs/en/scopes-overview

[Introduction](https://developers.tiktok.com/docs/en/welcome)[Scopes](https://developers.tiktok.com/docs/en/scopes-overview)Scopes Overview
Last updated August 19, 2026

*   [Managing scopes](https://developers.tiktok.com/docs/en/scopes-overview#managing_scopes)
*   [User authorization](https://developers.tiktok.com/docs/en/scopes-overview#user_authorization)
*   [Scopes Reference](https://developers.tiktok.com/docs/en/scopes-overview#scopes_reference)
...
See how to [manage user access tokens](https://developers.tiktok.com/docs/en/login-kit-manage-user-access-tokens) for `access_token` related endpoints.

![Image 1](https://sf16-sg.tiktokcdn.com/obj/tiktok-open-platform-sg/ttop_doc_images/bc614e2c5de500ca36eaaf187ee3a8f3)

## Scopes Reference

You can find the list of available scopes and their explanation on [the scopes reference page](https://developers.tiktok.com/docs/en/tiktok-api-scopes).