> This page location: TikTok for Developers > oauth-user-access-token-management
...
> Rendered from: https://r.jina.ai/https://developers.tiktok.com/docs/en/oauth-user-access-token-management
...
refresh_token string The token to refresh a user's `access_token`.
