> This page location: TikTok for Developers > content-sharing-guidelines
...
> Rendered from: https://r.jina.ai/https://developers.tiktok.com/docs/en/content-sharing-guidelines
...
![Image 1](https://sf16-sg.tiktokcdn.com/obj/tiktok-open-platform-sg/ttop_doc_images/0a0d2b2d52bb33c76e7b356d4f142750)
...
e. API clients should poll the [publish/status/fetch API](https://developers.tiktok.com/docs/en/content-posting-api-reference-get-video-status) or handle status update webhooks, so users can understand the status of their posts.
