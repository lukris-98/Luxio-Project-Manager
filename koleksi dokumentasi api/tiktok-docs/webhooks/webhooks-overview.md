> This page location: TikTok for Developers > webhooks-overview
> Full documentation base: https://developers.tiktok.com/docs/en/
> Source: https://developers.tiktok.com/docs/en/webhooks-overview
> Rendered from: https://r.jina.ai/https://developers.tiktok.com/docs/en/webhooks-overview

*   [Overview](https://developers.tiktok.com/docs/en/webhooks-overview#overview)
*   [Requirements and Limitations](https://developers.tiktok.com/docs/en/webhooks-overview#requirements_and_limitations)
