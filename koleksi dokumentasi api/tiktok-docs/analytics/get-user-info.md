> This page location: TikTok for Developers > tiktok-api-v2-get-user-info
> Full documentation base: https://developers.tiktok.com/docs/en/
> Source: https://developers.tiktok.com/docs/en/tiktok-api-v2-get-user-info
> Rendered from: https://r.jina.ai/https://developers.tiktok.com/docs/en/tiktok-api-v2-get-user-info

[Content Display](https://developers.tiktok.com/docs/en/content-display-landing)[Display API](https://developers.tiktok.com/docs/en/display-api-overview)[API Reference](https://developers.tiktok.com/docs/en/tiktok-api-v2-get-user-info)Get User Info
...
**HTTP Method**GET
**Scope**Needs [relevant scopes](https://developers.tiktok.com/docs/en/tiktok-api-v2-get-user-info#user_object) to be authorized by the TikTok user through the authorization flow.
