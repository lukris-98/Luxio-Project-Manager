> This page location: TikTok for Developers > display-api-get-started
> Full documentation base: https://developers.tiktok.com/docs/en/
> Source: https://developers.tiktok.com/docs/en/display-api-get-started
> Rendered from: https://r.jina.ai/https://developers.tiktok.com/docs/en/display-api-get-started
...
*   [iOS](https://developers.tiktok.com/docs/en/login-kit-ios-quickstart)
*   [Android](https://developers.tiktok.com/docs/en/login-kit-android-quickstart-v2)
*   [Web](https://developers.tiktok.com/docs/en/login-kit-web)
...
Follow this [tutorial](https://developers.tiktok.com/docs/en/login-kit-manage-user-access-tokens) to use the authorization code to retrieve the user's access token and open id.
...
2.   Call **[GET /v2/user/info/](https://developers.tiktok.com/docs/en/tiktok-api-v2-get-user-info)** API using access_token to get user profile information.
...
2.   Call **[POST /v2/video/list/](https://developers.tiktok.com/docs/en/tiktok-api-v2-video-list)** using the access token to get a list of a specified user's most recent videos. The returned videos are sorted by their creation time in descending order. 
...
2.   Schedule background jobs to keep the access token up-to-date using Refresh Token. This will fetch and update the user's recent TikTok videos every 12 hours.
...
1.   Call **[POST /v2/video/list/](https://developers.tiktok.com/docs/en/tiktok-api-v2-video-list)** using an access token to get a list of user's videos. This part is the same as displaying a user's recent TikTok videos.
2.   Design the UI to display the videos with `cover_image_url` and `duration`. 
3.   Allow the user to select videos to add to your app. After they complete their selection, save the metadata of the user's selected videos. Design the UI to present user's TikTok videos.
4.   The `cover_image_url` will expire after some time, so we need to call **[POST /v2/video/query/](https://developers.tiktok.com/docs/en/tiktok-api-v2-video-query)**to query the video metadata filtered by video_id.
