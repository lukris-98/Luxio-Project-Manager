> This page location: TikTok for Developers > content-posting-api-reference-upload-video
...
> Rendered from: https://r.jina.ai/https://developers.tiktok.com/docs/en/content-posting-api-reference-upload-video

[Share to TikTok](https://developers.tiktok.com/docs/en/content-publishing-landing)...Upload
Last updated August 4, 2026

*   [Overview](https://developers.tiktok.com/docs/en/content-posting-api-reference-upload-video#overview)
*   [Initialize Video Upload](https://developers.tiktok.com/docs/en/content-posting-api-reference-upload-video#initialize_video_upload)
    *   [Request](https://developers.tiktok.com/docs/en/content-posting-api-reference-upload-video#request)
        *   [Header](https://developers.tiktok.com/docs/en/content-posting-api-reference-upload-video#header)
        *   [Body](https://developers.tiktok.com/docs/en/content-posting-api-reference-upload-video#body)
        *   [Examples](https://developers.tiktok.com/docs/en/content-posting-api-reference-upload-video#examples)

    *   [Response](https://developers.tiktok.com/docs/en/content-posting-api-reference-upload-video#response)
        *   [Example](https://developers.tiktok.com/docs/en/content-posting-api-reference-upload-video#_example)
        *   [Error codes](https://developers.tiktok.com/docs/en/content-posting-api-reference-upload-video#_error_codes)

*   [Send Video to TikTok Servers](https://developers.tiktok.com/docs/en/content-posting-api-reference-upload-video#send_video_to_tiktok_servers)
    *   [Request](https://developers.tiktok.com/docs/en/content-posting-api-reference-upload-video#request_2)
        *   [Header](https://developers.tiktok.com/docs/en/content-posting-api-reference-upload-video#header_2)
        *   [Body](https://developers.tiktok.com/docs/en/content-posting-api-reference-upload-video#body_2)
        *   [Example](https://developers.tiktok.com/docs/en/content-posting-api-reference-upload-video#example)
...
2.   Send the video to TikTok servers (not needed if transfer method is `PULL_FROM_URL`).
...
video_url string The URL of the video to be uploaded. The domain or URL prefix of the video_url should already be verified. Learn more about [verifying the URL prefix](https://developers.tiktok.com/docs/en/content-posting-api-media-transfer-guide).true for `PULL_FROM_URL`
...
upload_url string The URL provided by TikTok where the video file can be uploaded.

The maximum length of this field is 256. This field is only for `source=FILE_UPLOAD`.
error code string You can decide whether the request is successful based on the error code. Any code other than `ok` indicates the request did not succeed. Learn more about [error codes](https://developers.tiktok.com/docs/en/content-posting-api-reference-upload-video#_error_codes).
...
403 spam_risk_too_many_pending_share The daily upload cap from the API is reached for the current user.
...
Once you have initialized the video upload and received an `upload_url`, you must send the video file to TikTok for processing. Many video formats are supported and chunking is provided for larger files. Learn more about [media transmission](https://developers.tiktok.com/docs/en/content-posting-api-media-transfer-guide).
