> This page location: TikTok for Developers > content-posting-api-reference-query-creator-info
> Full documentation base: https://developers.tiktok.com/docs/en/
> Source: https://developers.tiktok.com/docs/en/content-posting-api-reference-query-creator-info
> Rendered from: https://r.jina.ai/https://developers.tiktok.com/docs/en/content-posting-api-reference-query-creator-info

[Share to TikTok](https://developers.tiktok.com/docs/en/content-publishing-landing)...Query Creator Info
Last updated August 4, 2026

*   [Overview](https://developers.tiktok.com/docs/en/content-posting-api-reference-query-creator-info#overview)
*   [Request](https://developers.tiktok.com/docs/en/content-posting-api-reference-query-creator-info#request)
    *   [Header](https://developers.tiktok.com/docs/en/content-posting-api-reference-query-creator-info#header)
    *   [Example](https://developers.tiktok.com/docs/en/content-posting-api-reference-query-creator-info#example)

*   [Response](https://developers.tiktok.com/docs/en/content-posting-api-reference-query-creator-info#response)
    *   [Example](https://developers.tiktok.com/docs/en/content-posting-api-reference-query-creator-info#example_2)
    *   [Error Codes](https://developers.tiktok.com/docs/en/content-posting-api-reference-query-creator-info#_error_codes)
...
error code string You can decide whether the request is successful based on the error code. Any code other than `ok` indicates the request did not succeed. Learn more about [error codes](https://developers.tiktok.com/docs/en/content-posting-api-reference-query-creator-info#lATfV6).
message string A human readable description of the error.
logid string A unique identifier for the execution of this request.

**Note**: Your app needs to use fields returned in the respose.data to render your export screen. This will indicate the TikTok account to which the post will be published and provide creators with the available privacy settings they can choose from. Learn more about [the UX guidelines here](https://developers.tiktok.com/docs/en/content-sharing-guidelines).
...
(intentional)spam_risk_too_many_posts The daily post cap from the API is reached for the current user.
