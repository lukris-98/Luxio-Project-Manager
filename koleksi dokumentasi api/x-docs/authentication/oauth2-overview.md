> This page location: X Developer Platform > fundamentals/authentication/oauth-2-0/overview
> Source: https://docs.x.com/fundamentals/authentication/oauth-2-0/overview.md
