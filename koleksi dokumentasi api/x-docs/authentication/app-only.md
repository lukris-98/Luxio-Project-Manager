> This page location: X Developer Platform > fundamentals/authentication/oauth-2-0/application-only
> Source: https://docs.x.com/fundamentals/authentication/oauth-2-0/application-only.md
