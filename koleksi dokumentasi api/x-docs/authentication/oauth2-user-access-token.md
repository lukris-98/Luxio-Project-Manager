> This page location: X Developer Platform > fundamentals/authentication/oauth-2-0/user-access-token
> Source: https://docs.x.com/fundamentals/authentication/oauth-2-0/user-access-token.md
