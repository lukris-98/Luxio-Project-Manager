> This page location: X Developer Platform > x-api/posts/search-all-posts
> Full documentation index: https://docs.x.com/llms.txt
> Source: https://docs.x.com/x-api/posts/search-all-posts.md
...
paths:
  /2/tweets/search/all:
    get:
      ...
      description: >-
        At most one of `start_time`, `since_id` may be provided. At most one of
        `end_time`, `until_id` may be provided. At most one of
        `pagination_token`, `next_token` may be provided.
