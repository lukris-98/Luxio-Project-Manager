> This page location: X Developer Platform > x-api/users/get-reposts-of-me
> Full documentation index: https://docs.x.com/llms.txt
> Source: https://docs.x.com/x-api/users/get-reposts-of-me.md
...
````yaml get /2/users/reposts_of_me
openapi: 3.0.0
info:
