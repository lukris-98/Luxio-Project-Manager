> This page location: X Developer Platform > x-api/users/get-mentions
> Full documentation index: https://docs.x.com/llms.txt
> Source: https://docs.x.com/x-api/users/get-mentions.md
...
paths:
  /2/users/{id}/mentions:
    get:
      ...
      description: >-
        When both are provided, `start_time` must be earlier than `end_time`.
        When both are provided, `since_id` must be less than `until_id`.
