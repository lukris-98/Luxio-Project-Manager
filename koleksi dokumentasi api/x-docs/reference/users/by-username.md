> This page location: X Developer Platform > x-api/users/get-user-by-username
> Full documentation index: https://docs.x.com/llms.txt
> Source: https://docs.x.com/x-api/users/get-user-by-username.md
...
````yaml get /2/users/by/username/{username}
openapi: 3.0.0
info:
